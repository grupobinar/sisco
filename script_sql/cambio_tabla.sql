...
'15'::integer, 'Liquidacion'::character varying(50), 'fa fa-circle-o'::character varying(50), '17'::integer, 'index.php/polizas/liquidacion'::character varying(200), '0'::integer)
 returning id_menu;

INSERT INTO public.t_menu (
id_padre, item, icono, orden, ruta, hijos) VALUES (
'15'::integer, 'Pre-Liquidacion'::character varying(50), 'fa fa-circle-o'::character varying(50), '18'::integer, 'index.php/polizas/preliquidacion'::character varying(200), '0'::integer)
 returning id_menu;
