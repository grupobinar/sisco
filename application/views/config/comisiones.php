 ...
 <div class="col-lg-12 box">
   <table width="50%" style="margin: 20px">
     <tr>
       ...
       <td><?php echo $_ci_vars['ccoordinador']->comision_c."% Sobre la comisión del vendedor";?></td>
...
<!-- #Agregar Usuario ############################################################################-->
<?=form_open_multipart(base_url().'index.php/config/modificar_comision_coordinador')?>
  <div class="modal fade" id="editCoordinador" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><i class="fa fa-bank"></i> Editar Comisión Coordinador</h4>
        </div>
        <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6"><b>Porcentaje de Calculo</b></div>
              <div class="col-lg-3"><input type="text" name="num_calculo" id="num_calculo" class="form-control numero"></div>
              <input type="hidden" name="id_comision_coordinador" id="id_comision_coordinador">
            </div>
        </div>
...
$(document).ready(function(){
    ...
    $(".editCoordinador").click(function() {
      $.post("<?php echo base_url() ?>/index.php/config/buscarComisionCoordinador", { id:$(this).attr("id") }, function(data){

        console.log(data);
        
        var result=data.split(':');

        $("#num_calculo").val(result[0]);
        $("#id_comision_coordinador").val(result[1]);
